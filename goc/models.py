...
class Author(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(20), nullable=False)
    blogs = db.relationship('Blog', backref='authorr', lazy=True)
